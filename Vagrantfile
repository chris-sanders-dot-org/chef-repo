...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "cfsanders-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/cfsanders"
  #   chef.validation_client_name = "cfsanders-validator"
  #   chef.validation_key_path = ".chef/cfsanders-validator.pem"
  # end
end
